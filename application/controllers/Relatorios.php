...
*/
    		 ...
    		 if($contas == 'vencidas' || $contas == 'pagas' || $contas == 'receber'){
    		 	...
    		 	if($contas == 'vencidas'){
    		 		...
    		 		$empresa = $this->core_model->get_by_id('sistema', array('sistema_id' => 1));
						...
						$contas = $this->financeiro_model->get_contas_receber_relatorios($conta_receber_status, $data_vencimento);
							/*echo'<pre>';
							print_r($contas);*/
	...
	$valor_final_contas = $this->financeiro_model->get_sum_contas_receber_relatorios($conta_receber_status, $data_vencimento);
