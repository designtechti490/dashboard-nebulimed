			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="/receber">Contas à Receber</a></li>
      ...
      <fieldset class="mt-4 border p-2">
       ...
       <div class="form-group row">
         <div class="col-sm-6 mb-3 ">
          ...
          <div class="col-sm-2 mb-3">
            ...
            <input type="date" name="conta_receber_data_vencimento" class="form-control form-control-user-date" value="<?php set_value('conta_receber_data_vencimento')?>">
            <?php echo form_error('conta_receber_data_vencimento','<small class="form-text text-danger">','</small>'); ?>
          </div>

          <div class="col-sm-2 mb-3">
            <label>Valor da conta</label>
            <input type="text" name="conta_receber_valor" class="form-control form-control-user-date money2" value="<?php set_value('conta_receber_valor')?>">
       ...
       <div class="form-group row  mb-3">
        <div class="col-sm-12 mb-3">
          ...
          <textarea class="form-control" name="conta_receber_obs" placeholder="Histórico da conta"><?php set_value('conta_receber_obs')?></textarea>
        </div>
      </div>
    </div>
  </fieldset>
