        ...
        <!-- Sidebar -->
        <ul class="topbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/">
				<img src="<?= base_url('public/img/logo-white.png'); ?>" alt="Logotipo" class="logo">
            </a>
			...
			<li class="nav-item">
				...
				<div id="collapseQuatro" class="collapse" aria-labelledby="headingUtilities"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<h6 class="collapse-header">Escolha uma opção</h6>
						<a class="collapse-item" title="Gerenciar contas a pagar" href="<?php echo base_url('pagar');?>"><i class="fas fa-dollar-sign mr-2"></i>Contas a pagar</a>
