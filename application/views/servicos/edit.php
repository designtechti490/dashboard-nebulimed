       ...
       <div class="card shadow mb-2 ">
        <div class="card-header py-0 " style="background-color:#f5f5f5; border-bottom: 1px solid #9e9e9e;">
            <h6 class="m-0 font-weight-bold text-primary float-left mt-3"><?php echo $titulo ?></h6>
             <p class="text-right mt-3 text-danger"><strong> <i class="fas fa-clock"></i>&nbsp;&nbsp; Última alteração:</strong> <?php echo formata_data_banco_com_hora($servicos->servico_data_alteracao);?></p>
        </div>
        <div class="card-body">
            ...
            <form method="post" name="form_edit" class="user">
               ...
               <div class="form-group row">
                <div class="col-sm-4 mb-3 mb-sm-0">
                    ...
                    <input type="text" name="servico_nome" class="form-control form-control-user" value="<?php echo $servicos->servico_nome ?>"placeholder="Serviços">
                    <?php echo form_error('servico_nome','<small class="form-text text-danger">','</small>'); ?>
                </div>
                <div class="col-sm-4">
                    <label>Preço</label>
                    <input type="text" name="servico_preco" class="form-control form-control-user money" value="<?php echo $servicos->servico_preco?>"
                    placeholder="Preços">
                ...
                <div class="col-sm-4 ">
                  ...
                  <option value="2"<?php echo($servicos->servico_ativo == 2) ? 'selected':'' ?>>Não</option>
              </select>
                    
                </div>
                <div class="col-sm-12 mt-2">
                    <label>Histórico do Serviço</label>
                    <textarea name="servico_descricao" class="form-control"><?php echo $servicos->servico_descricao ?></textarea>
