			...
			<div class="container-fluid">
				...
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="/pagamentos">Formas de Pagamentos</a></li>				
      ...
      <fieldset class="mt-4 border p-2">
       ...
       <div class="form-group row">
        <div class="col-sm-4 mb-3 mb-sm-0">
          <label>Nome </label>
          <input type="text" name="forma_pagamento_nome" class="form-control form-control-user" value="<?php set_value('forma_pagamento_nome') ?>"placeholder="Forma de pagamentos">
