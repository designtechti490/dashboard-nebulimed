<?php $this->load->view('layout/sidebar'); ?>
   ...
   <div class="card shadow mb-2 ">
    <div class="card-header py-0 " style="background-color:#f5f5f5; border-bottom: 1px solid #9e9e9e;">
      ...
      <p class="text-right mt-3 text-danger"><strong> <i class="fas fa-clock"></i>&nbsp;&nbsp; Última alteração:</strong> <?php echo formata_data_banco_com_hora($produtos->produto_data_alteracao);?></p>
    </div>
    <div class="card-body">
      ...
      <fieldset class="mt-4 border p-2">
       ...
       <div class="form-group row">
        <div class="col-sm-4 mb-3 mb-sm-0 p-2">
          ...
          <input type="text" name="produto_codigo" class="form-control form-control-user" value="<?php echo $produtos->produto_codigo ?>" readonly="">

        </div>
        <div class="col-sm-8 mb-3 mb-sm-0 p-2">
          <label>Descrição do produto</label>
          <input type="text" name="produto_descricao" class="form-control form-control-user " value="<?php echo $produtos->produto_descricao?>"
      ...
      <div class="form-group row">
          ...
          <select class="custom-select" name="produto_marca_id">
            <?php foreach ($marcas as $marca) :?>
              <option  value="<?php echo $marca->marca_id ?>">
               <?php echo ($marca->marca_id == $produtos->produto_marca_id ? 'selected' : '') ?> 
          ...
          <select class="custom-select" name="produto_categoria_id">
            ...
            <?php foreach ($categorias as $categoria) :?>
              <option value="<?php echo $categoria->categoria_id ?>">
                <?php echo ($categoria->categoria_id == $produtos->produto_categoria_id ? 'selected' : '') ?>
          ...
          <select class="custom-select" name="produto_fornecedor_id">
           <?php foreach ($fornecedores as $fornecedor) :?>
             <option value="<?php echo $fornecedor->fornecedor_id ?>">
              <?php echo ($fornecedor->fornecedor_id == $produtos->produto_fornecedor_id ? 'selected' : '') ?> 
        ...
        <div class="col-sm-3 mb-3 mt-3">
          ...
          <input type="text" name="produto_unidade" class="form-control form-control-user " value="<?php echo $produtos->produto_unidade ?>"
        placeholder="Unidade do produto ">
        <?php echo form_error('produto_unidade','<small class="form-text text-danger">','</small>'); ?>
       </div>
        <div class="col-sm-6 mb-3 mt-3">
          <label>Código de barra</label>
          <input type="text" name="produto_codigo_barras" class="form-control form-control-user " value="<?php echo $produtos->produto_codigo_barras?>"
        ...
        <div class="col-sm-6 mb-3 mt-3">
          ...
          <input type="text" name="produto_ncm" class="form-control form-control-user " value="<?php echo $produtos->produto_ncm?>"
      ...
      <div class="form-group row">
       ...
       <div class="col-sm-3">
        ...
        <input type="text" name="produto_preco_custo" class="form-control form-control-user money" value="<?php echo $produtos->produto_preco_custo?>"
     ...
     <div class="col-sm-3">
        ...
        <input type="text" name="produto_preco_venda" class="form-control form-control-user money" value="<?php echo $produtos->produto_preco_venda?>"
      ...
      <div class="col-sm-3">
        ...
        <input type="number" name="produto_estoque_minimo" class="form-control form-control-user money" value="<?php echo $produtos->produto_estoque_minimo?>"
      ...
      <div class="col-sm-3">
        ...
        <input type="number" name="produto_qtde_estoque" class="form-control form-control-user money" value="<?php echo $produtos->produto_qtde_estoque?>"
    ...
    <div class="col-sm-4 mt-3">
      ...
      <select class="form-control form-control-ativo" name="produto_ativo">
        <option value="1"<?php echo($produtos->produto_ativo == 1) ? 'selected':'' ?>>Sim</option>
        <option value="2"<?php echo($produtos->produto_ativo == 2) ? 'selected':'' ?>>Não</option>
      </select>

    </div>
    <div class="col-sm-8 mt-3">
      <label>Histórico do produto</label>
      <textarea name="produto_descricao" class="form-control form-control-user"><?php echo $produtos->produto_descricao ?></textarea>
      <?php echo form_error('produto_descricao','<small class="form-text text-danger">','</small>'); ?>
    </div>
</div>
    <div class="mb-3 mt-3">
