            ...
            <form method="post" name="form_add" class="user">
                ...
                <?php if($message = $this->session->flashdata('sucesso')): ?>
                  ...
                  <fieldset class="mt-4 border p-2">
                     <legend class="font-small"><i class="fas fa-laptop-house mr-2"></i>Dados da Categoria</legend>
               <div class="form-group row">
                <div class="col-sm-6 mb-3 mb-sm-0">
                    <label>Nome da categoria</label>
        <input type="text" name="categoria_nome" class="form-control form-control-user" value="<?php echo set_value('categoria_nome') ?>"placeholder="Nome da categoria">
