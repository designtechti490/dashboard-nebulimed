                        ...
                        <div class="row">
                            <div class="col-md-8 mt-2">
                                ...
                                <div class="col-md-4 text-right">
                                 <a href="<?php echo base_url('fornecedores/add'); ?>" title="Cadastrar novo usuário" class="btn btn-success btn-sm "><i class="fas fa-user-plus mr-1"></i>Novo</a>
                             </div>
                         </div>
                     </div>  
                        <div class="card-body">
                                ...
                                <table class="table table-bordered dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php foreach ($fornecedores as $fornecedor): ?>
                                     <tr>
                                            ...
                                            <td class="text-center"><?php echo $fornecedor->fornecedor_cnpj; ?></td>
                                            <td class="text-center"><?php echo ($fornecedor->fornecedor_celular); ?></td>
                                            
                        <td class="text-center"><?php echo ($fornecedor->fornecedor_ativo  == 1 ? '<span class="badge badge-success badge-shadow btn-sm">Sim</span>' : '<span class="badge badge-danger badge-shadow btn-sm">Não</span>'); ?></td>

                <td class="text-center">
                      <a href="<?php echo base_url('fornecedores/edit/'.$fornecedor->fornecedor_id); ?>" class="btn btn-icon btn-primary mr-2"><i class="fas fa-user-edit"></i></i></a>
                      <a href="javascript(void)" data-toggle="modal" data-target="#user-<?php echo $fornecedor->fornecedor_id;?>" class="btn btn-icon btn-danger"><i class="fas fa-user-times"></i></a>
                    </td>    
                                        </tr>

                                           <!-- Logout Modal-->
                                        <div class="modal fade" id="user-<?php echo $fornecedor->fornecedor_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
